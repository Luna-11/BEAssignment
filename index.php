...
<body class="bg-[#f9f1e5] text-[#7b4e48] min-h-screen flex flex-col">
    ...
    <!-- Promotion Section -->
    <section class="promo w-full text-center overflow-hidden">
      <img src="./BEpics/event1.png" alt="Promo Image" class="max-w-full h-auto block mx-auto">
    </section>
    ...
    <!-- Footer -->
    <footer class="footer bg-[#C89091] text-white py-5">
      <div class="container mx-auto px-4">
        <div class="footer-content grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div class="footer-section">
            <h4 class="text-base md:text-lg font-semibold mb-3">Contact Us</h4>
            <ul class="space-y-2 text-sm md:text-base">
        ...
        <div class="footer-bottom border-t border-white border-opacity-20 pt-4 mt-6 md:mt-8 text-center text-sm md:text-base">
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        // The CSS :hover selectors will handle this case
      });
    </script>
